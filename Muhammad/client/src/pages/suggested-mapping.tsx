...
import MappingGrid from "../components/MappingGrid"; // <-- move MappingGrid into /components
import { mock_suggested_mapping } from "../mockData";

const SuggestedMapping = () => {
  const mappings = mock_suggested_mapping?.mappings || [];

  console.log("Loaded mappings:", mappings.length);
